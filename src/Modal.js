...
const propTypes = {
  ...
  /**
   * @property {PropTypes.bool} keyboard - Close the modal when escape key is pressed
   */
  keyboard: PropTypes.bool,

  /**
   * @property {PropTypes.bool} animation - Open and close the Modal with a slide and fade animation.
   */
  ...
  /**
   * @property {PropTypes.bool} enforceFocus -
  ...
  /**
   * @property {PropTypes.bool} restoreFocus -
  ...
  /**
   * @property {PropTypes.bool} show - When `true` The modal will show itself.
   */
  show: PropTypes.bool,

  /**
   * @property {PropTypes.func} onHide - A callback fired when the header closeButton or non-static backdrop is
   * clicked. Required if either are specified.
   */
  onHide: PropTypes.func,

  /**
   * @property {PropTypes.func} onEnter - Callback fired before the Modal transitions in
   */
  onEnter: PropTypes.func,

  /**
   * @property {PropTypes.func} onEntering - Callback fired as the Modal begins to transition in
   */
  onEntering: PropTypes.func,

  /**
   * @property {PropTypes.func} onEntered - Callback fired after the Modal finishes transitioning in
   */
  onEntered: PropTypes.func,

  /**
   * @property {PropTypes.func} onExit - Callback fired right before the Modal transitions out
   */
  onExit: PropTypes.func,

  /**
   * @property {PropTypes.func} onExiting - Callback fired as the Modal begins to transition out
   */
  onExiting: PropTypes.func,

  /**
   * @property {PropTypes.func} onExited - Callback fired after the Modal finishes transitioning out
   */
