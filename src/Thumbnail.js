...
const propTypes = {
  ...
  /**
   * @property {PropTypes.func} onError - onError callback that is passed down to the image inside this component
   */
  onError: PropTypes.func,
  /**
   * @property {PropTypes.func} onLoad - onLoad callback that is passed down to the image inside this component
   */
