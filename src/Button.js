 ...
 * @property {PropTypes.bool} active - deafult is false.
 * @property {PropTypes.bool} block - default is false.
 * @property {PropTypes.bool} disabled - default is false.
 * @property {PropTypes.func} onClick - to be invoked on button click.
