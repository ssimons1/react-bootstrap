 ...
 *
 * @property {PropTypes.bool} in - Show the component; triggers the expand or collapse animation.
 * @property {PropTypes.bool} mountOnEnter - Wait until the first "enter" transition to mount the component (add it to the DOM).
 * @property {PropTypes.bool} unmountOnExit - Unmount the component (remove it from the DOM) when it is collapsed.
 * @property {PropTypes.bool} transitionAppear - Run the expand animation when the component mounts, if it is initially shown.
 ...
 * @property {PropTypes.func} onEnter - Callback fired before the component expands.
 * @property {PropTypes.func} onEntering - Callback fired after the component starts to expand.
 * @property {PropTypes.func} onEntered - Callback fired after the component has expanded.
 * @property {PropTypes.func} onExit - Callback fired before the component collapses.
 * @property {PropTypes.func} onExiting - Callback fired after the component starts to collapse.
 * @property {PropTypes.func} onExited - Callback fired after the component has collapsed.
 * @property {height|width|PropTypes.func} dimension - The dimension used when collapsing, or a function that returns the dimension.
 * @property {PropTypes.func} getDimensionValue - A function that returns the height or width of the animating DOM node. Allows for providing some custom logic for how much the Collapse component should animate in its specified dimension. Called with the current dimension prop value and the DOM node.
