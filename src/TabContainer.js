...
const propTypes = {
  ...
  /**
   * @property {PropTypes.func} generateChildId - A function that takes an `eventKey` and `type` and returns a unique id for
  ...
  /**
   * @property {PropTypes.func} onSelect - A callback fired when a tab is selected.
   *
