...
const propTypes = {
  ...
  /**
   * @property {PropTypes.bool|elementType} animation - Use animation when showing or hiding `<TabPane>`s. Use `false` to disable,
  ...
  /**
   * @property {PropTypes.func} onEnter - Transition onEnter callback when animation is not `false`
   */
  onEnter: PropTypes.func,
  /**
   * @property {PropTypes.func} onEntering - Transition onEntering callback when animation is not `false`
   */
  onEntering: PropTypes.func,
  /**
   * @property {PropTypes.func} onEntered - Transition onEntered callback when animation is not `false`
   */
  onEntered: PropTypes.func,
  /**
   * @property {PropTypes.func} onExit - Transition onExit callback when animation is not `false`
   */
  onExit: PropTypes.func,
  /**
   * @property {PropTypes.func} onExiting - Transition onExiting callback when animation is not `false`
   */
  onExiting: PropTypes.func,
  /**
   * @property {PropTypes.func} onExited - Transition onExited callback when animation is not `false`
   */
  onExited: PropTypes.func,
  /**
   * @property {PropTypes.bool} mountOnEnter - Wait until the first "enter" transition to mount the tab (add it to the DOM)
   */
  mountOnEnter: PropTypes.bool,
  /**
   * @property {PropTypes.bool} unmountOnExit - Unmount the tab (remove it from the DOM) when it is no longer visible
   */
