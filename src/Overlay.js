...
const propTypes = {
  ...
  /**
   * @property {boolean} show - Set the visibility of the Overlay
   */
  show: PropTypes.bool,
  /**
   * @property {boolean} rootClose - Specify whether the overlay should trigger onHide when the user clicks outside the overlay
   */
  rootClose: PropTypes.bool,
  /**
   * @property {function} onHide - A callback invoked by the overlay when it wishes to be hidden. Required if
   * `rootClose` is specified.
   */
  onHide: PropTypes.func,

  /**
   * @property {boolean | elementType} animation - Use animation
   */
  ...
  /**
   * @property {top|right|bottom|left} placement - Sets the direction of the Overlay.
   */
